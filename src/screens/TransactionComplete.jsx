...
const TransactionComplete = () => {
  ...
  const {email, description, amount, coin, isError} = useRoute().params
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          {
            isError.code !== 200 || 201
              ? (
                <View style={{alignItems: 'center', justifyContent: 'space-around', height: "100%"}}>
                  <View style={{backgroundColor: theme.colors.lightRed, borderRadius: width, padding: 30, minWidth: "40%", maxWidth: "40%"}}>
                    <Icon type='font-awesome-5' name='exclamation' color={theme.colors.red} size={70}/>
                  </View>
                  <View>
                    <StyledText fontSize="xl" fontWeight="light" color="blue">¡Operación fallida!</StyledText>
                  </View>
                  <View style={{width: width * 0.70, alignItems: 'center', justifyContent: 'center'}}>
                    <StyledText fontWeight="bold" fontSize="medium" color="blue">{isError.message}</StyledText>
                  </View>
